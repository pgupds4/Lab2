...
5. **Тест на работу с большим массивом (проверка производительности)**:
    ...
    **Input**:
    ...
    ```
    **Ожидаемый вывод**:
    - Программа должна корректно обработать большой массив размером 100x100 и выполнить все операции (сортировка строк, поиск максимума среди минимумов, вывод по спирали и поворот).
...
6. **Тест на пустой массив**:
    ...
    **Input**:
    ...
    ```
    **Ожидаемый вывод**:
    - Программа должна корректно обработать случай с пустым массивом (не выдавая ошибок и не выполняя лишних операций).
